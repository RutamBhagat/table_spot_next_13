      ...
      <div className="flex">
        <div className="relative w-full">
          ...
          <button
            ...
            type="submit"
            className="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-[#5942e9] rounded-r-lg border border-[#5942e9] hover:bg-[#4030a8] focus:ring-4 focus:outline-none focus:ring-blue-300"
          >
            <svg
              aria-hidden="true"
              className="w-5 h-5"
