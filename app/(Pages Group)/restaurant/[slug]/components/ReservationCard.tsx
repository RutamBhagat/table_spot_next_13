...
export default function ReservationCard({ open_time, close_time, slug }: Props) {
    ...
    <div className="fixed bottom-0 right-0 w-[20%] bg-white rounded p-3 shadow">
      ...
      <div className="my-3 flex flex-col">
        ...
        <select
          ...
          value={partySize}
          name=""
          className="py-3 border-b font-light pl-3 rounded-md"
          id=""
        >
          {partySizes.map((size) => (
      ...
      <div className="flex justify-between">
        <div className="flex flex-col w-[48%]">
          ...
          <DatePicker
            ...
            dateFormat="MMMM d"
            className="py-2.5 border-b font-light text-reg w-full pl-3 rounded-md bg-gray-200"
          />
        </div>
        <div className="flex flex-col w-[48%]">
          <label className="pl-3" htmlFor="">
